            ...
            .then(data => {
                ...
                if (Array.isArray(items)) {
                    items.forEach(item => {
                        ...
                        //                     <hr>`;
                        document.querySelector('.temper').textContent = item.temp;
                        document.querySelector('.place').textContent = item.place;
                        document.querySelector('.describe').textContent = item.description;
                    });
